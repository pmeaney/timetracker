...
import { toggle_Visibility_Viewport_TaskList, sendData_to_Modal_MoreInfo } from "./redux/actions"
...
class Viewport_TaskList extends Component {
  constructor() {
    ...
    this.HandleClick_MoreInfo_Modal = this.HandleClick_MoreInfo_Modal.bind(
      this
    );
  }
  ...
  HandleClick_MoreInfo_Modal(activity_obj_activity_id, e) {
    console.log('activity_obj_activity_id', activity_obj_activity_id)
    this.setState({
      clicked_more_info_id: activity_obj_activity_id
    })
    // clicked_more_info_id
    // console.log('HandleClick_MoreInfo_Modal info_obj', info_obj)
    // this.props.sendData_to_Modal_MoreInfo(info_obj)
  }
  ...
  render() {
    ...
    const existingTaskCards = this.state.employee_data_existingTasks_forClockOut.map((obj, i) => {
      ...
      return( 
        <div key={obj.activity_id} className="column makeFixedColumnWidth">
          <div className="card">
            ...
            {/* <footer className="card-footer"> */}
              ...
              {this.state.clicked_more_info_id === obj.activity_id ?
                <Modal_MoreInfo
                  className="card-footer-item"
                ...
                <a
                  ...
                  className="card-footer-item"
                  onClick=
                  {e => this.HandleClick_MoreInfo_Modal(obj.activity_id, e)}
                >More Info</a>
              } */}
              ...
              {/* {this.state.clicked_activity_id === obj.activity_id ? 
              <Modal_MoreInfo 
                // FnFor_OnClick={ e => this.HandleClick_MoreInfo_Modal(obj, e)}
                activity_obj={obj}
                />
              ...
              {/* <a
                ...
                className="card-footer-item"
                onClick=
                {e => this.HandleClick_MoreInfo_Modal(obj, e)}
              ><Modal_MoreInfo /></a> */}
        ...
        <div key={obj.activity_id} className="column makeFixedColumnWidth">
          <div className="card">
            ...
            {this.state.loading && this.state.clicked_activity_id === obj.activity_id ?
              ...
              {/* need to add an onClick method which tracks the clicked activity, 
               Then, select which entire object to send through, based on which one was clicked */}
...
//   visibility_modal_more_info: store.visibility_modal_more_info
// })

const mapDispatchToProps = {
  toggle_Visibility_Viewport_TaskList,
  sendData_to_Modal_MoreInfo
}
