...
var two_weeks_ago_at_midnight = new Date(right_now - default_timeframe).setHours(0, 0, 0, 0)
var tonight_at_11_59pm =  new Date().setHours(23,59)

// setting default variables
// Begin default datetime: two weeks ago at midnight
const default_beginDate = two_weeks_ago_at_midnight     // only the date matters
const default_beginTime = two_weeks_ago_at_midnight // only the time matters: midnight
const default_endDate = tonight_at_11_59pm // only the date matters
const default_endTime = tonight_at_11_59pm // only the time matters
