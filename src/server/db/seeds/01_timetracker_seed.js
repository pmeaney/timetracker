    ...
    .then(() => {
      return Promise.all([
          ...
          knex('timesheets').insert([
            ...
            { timesheet_id: 4, activity_id: 4, emp_authorized_by: 3, emp_accepted_by: 1, cost_center_id: 1,  timesheet_notes: 'nothing to report', timesheet_submitted_datetime: '2018-02-14T15:02:00.000Z', timesheet_clockin: '2018-02-03T13:00:00.000Z', timesheet_clockout: '2018-02-02T00:05:00.000Z',                             timesheet_clockin_lat: '37.684678', timesheet_clockin_long: '-122.40333', timesheet_clockout_lat: '37.684146', timesheet_clockout_long: '-122.40240'},
            { timesheet_id: 5, activity_id: 5, emp_authorized_by: 2, emp_accepted_by: 4, cost_center_id: 1,  timesheet_notes: 'drywall done. sealant needs 48 hours to dry', timesheet_submitted_datetime: '2018-02-04T13:05:00.000Z', timesheet_clockin: '2018-02-04T13:05:00.000Z', timesheet_clockout: '2018-02-02T00:05:00.000Z',   timesheet_clockin_lat: '37.684518', timesheet_clockin_long: '-122.40103', timesheet_clockout_lat: '37.684156', timesheet_clockout_long: '-122.40240'},
          ])
