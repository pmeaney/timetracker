    ...
    .then(() => {
      return Promise.all([
          ...
          knex('activities').insert([
            ...
            { activity_id: 7, activity_code: 8, project_id: 3, emp_assigned_by: 1, emp_assigned_to: 2, activity_notes: 'Testing 2...', activity_datetime_begin: '2018-02-04T13:00:00.000Z', activity_datetime_end: '2018-02-08T21:00:00.000Z'},
          ])
        ])
    })
    .then(() => {
